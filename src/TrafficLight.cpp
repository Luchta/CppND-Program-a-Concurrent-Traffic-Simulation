...
double TrafficLight::getRandSeconds(){
    return (1000 * (rand() % 4 + 2));
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    double cycleDuration = getRandSeconds(); // duration of a single simulation cycle in seconds
    ...
    while(true){
        ...
        if (timeSinceLastUpdate >= cycleDuration)
        {
            ...
            // get a new random cycle duration
            cycleDuration = getRandSeconds();
